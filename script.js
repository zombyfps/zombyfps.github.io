...
const texts = {
  ...
  ar: {
    aboutText: "مرحباً! أنا  حاليت، لكن أصدقائي ينادونني زومبي . وُلدت عام ١٩٩٩ في أضنة ونشأت في طرابزون. البث بالنسبة لي ليس مجرد ألعاب؛ بل لقاء أشخاص جدد والدردشة والاستمتاع معاً.",
